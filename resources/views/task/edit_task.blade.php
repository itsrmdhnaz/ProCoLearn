        ...
        <div class="flex justify-between items-center mx-5 mt-4">
            ...
            <div class="relative">
                ...
                <div class="hidden absolute right-0 mt-2 w-40 bg-dark rounded-lg shadow-lg py-2" id="dropdownMenu">
                    <button
                        class="w-full px-4 py-2 text-orangeCustom hover:bg-lightDark2 text-left flex items-center gap-2">
            ...
            <div class="content-wrapper scrolled-text bg-dark rounded-t-3xl">
                <div class="flex-1 py-5">
                            ...
                            <div class="flex items-center gap-2">
                                <div class="flex items-center border-2 border-lightDark p-1 rounded-2xl w-fit gap-1 ">
                                    <div
                                        ...
                                        F</div>
                                    <p class="text-orangeCustom text-xs font-medium">Fajar Sahab</p>
                                </div>
                                <i class="ti ti-x text-orangeCustom"></i>
                            </div>
                        @endfor
                    </div>
                    ...
                    <div class="space-y-4 px-5 mt-6">
                        ...
                        <div class="flex items-center gap-3">
                            <i class="ti ti-plus text-light text-xl"></i>
                            <p class="text-lightDark2">Add New Sub Task</p>
                        </div>
                    </div>

                    <hr class="border-lightDark mt-6">
