<x-guest-layout>
    ...
    <form method="POST" action="{{ route('login') }}">
        ...
        <a href="{{ URL::to('googleLogin') }}">
            <button type="button" class="mt-1 border btn btn-block d-flex justify-content-center align-items-center" style="gap: 0.5rem;">
                <img src="{{ asset('app-assets/images/icons/google.jpg') }}" width="25"/>
                <span>
                    Login With Google
                </span>
            </button>
