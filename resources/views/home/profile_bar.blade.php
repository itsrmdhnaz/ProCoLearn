<div class="flex-col max-w-[20%] h-screen min-w-[281px] flex-shrink-0  mdm:flex">
    ...
    <div
        ...
        <div class="flex-1 flex flex-col min-h-0 mx-3">
            ...
            <div class="overflow-y-auto mdm:max-h-52 scrolled-text">
                @for ($i = 0; $i < 8; $i++)
    ...
    <div class="bg-lightDark sm:flex gap-3 fixed inset-0 h-screen w-full z-20 hidden mdm:hidden">
        ...
        <div class="flex-1 flex flex-col overflow-hidden">
            ...
            <!-- Tambahkan h-full dan overflow-hidden di sini -->
            <div class="bg-dark h-full overflow-hidden flex flex-col">
                <i
                    class="ti ti-chevron-left sm:hidden cursor-pointer text-3xl text-center text-white mt-6 flex justify-start mx-6 flex-shrink-0"></i>
                <i
                    class="ti ti-x hidden cursor-pointer mdm:hidden text-3xl text-center text-white mt-6 sm:flex justify-end mx-6 flex-shrink-0"></i>
                ...
                <div class="flex-shrink-0 w-full">
                    ...
                    <!-- Recommendation friends section -->
                    <div class="flex-1 mx-3">
                        <div class="my-5 w-full flex justify-between">
                            <p class="text-sm font-bold text-white text-left">Make Your Friends</p>
                            <div class="flex gap-2 items-center">
                                {{-- <p class="text-sm font-bold text-white text-left">Refresh</p> --}}
                                <i
                                class="ti ti-reload cursor-pointer text-xl text-center text-white flex-shrink-0 mr-2"></i>
                            </div>
                        </div>
                        <!-- Menggunakan grid untuk 2 kolom dengan auto-rows -->
                        <div class="grid grid-cols-2 gap-2 h-full auto-rows-auto">
                            <!-- Tidak perlu pembagian kolom manual, biarkan grid mengatur secara otomatis -->
                            @for ($i = 0; $i < 6; $i++)
                                <x-friends-rec-card>Fajar Sahab</x-friends-rec-card>
                            @endfor
                        </div>
