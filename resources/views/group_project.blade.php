...
<body class="bg-lightDark h-screen">
    ...
    <div class="h-screen max-w-screen-2xl mx-auto overflow-hidden bg-lightDark flex flex-col">
        <!-- Header Section -->
        <div class="flex w-full gap-3 flex-row my-4 sm:hidden px-4">
            {{-- logo in mobile --}}
        ...
        <!-- Filter Button -->
        <div class="px-4 py-3 flex justify-end sm:hidden">
            <button
        ...
        <div class="flex-1 overflow-y-auto scrolled-text sm:overflow-hidden sm:flex sm:h-screen">
            <x-side-bar-project></x-side-bar-project>
            <!-- Scrollable Content Area -->
            <div class="sm:flex-1 scrolled-text px-4 overflow-y-auto scrolled-text sm:overflow-hidden">
                <div class="hidden sm:flex mt-4 gap-2 items-center">
                    {{-- search --}}
                ...
                <p class="text-white text-2xl font-semibold mt-4 ml-4 hidden sm:block">New Project Groups Released</p>
                {{-- nearby project --}}
                <div class="space-y-4 sm:space-x-4 sm:flex sm:overflow-x-auto scrolled-text">
                    <div class="h-4 sm:h-0"></div>
                    @for ($i = 0; $i < 5; $i++)
                        <div class="bg-dark rounded-3xl p-2 max-w-sm min-w-80 mx-auto">
                ...
                <p class="text-white text-2xl font-semibold mt-4 ml-4 hidden sm:block">Top Project Groups</p>
                <div class="space-y-4 space-x-4 hidden sm:flex overflow-x-auto scrolled-text">
                    <div class="h-4 sm:h-0"></div>
                    @for ($i = 0; $i < 5; $i++)
                        <div class="bg-dark rounded-3xl p-2 max-w-sm min-w-80 mx-auto">
                            <div class="bg-lightDark rounded-t-3xl h-36 mb-2">
        ...
        <!-- Bottom Navigation -->
        <div class="bg-dark p-4 flex justify-around items-end sm:hidden">
            <button>
